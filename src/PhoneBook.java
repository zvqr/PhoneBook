...
public class PhoneBook {
    ...
    private static void listCommands() {
        ...
        System.out.println("show a contact - searches for a specific record by name");
        System.out.println("find a contact - searches for a specific record by number");
    ...
    private static void loadContacts(Map<String, List<String>> contacts) {
        try (BufferedReader reader = new BufferedReader(new FileReader(DATA_PATH))) {
            ...
            Pattern pattern = Pattern.compile("^([^,\"]{2,50}),\"([\\d+, ]+)\"$");
    ...
    private static void showContact(Map<String, List<String>> contacts, Scanner input) {
        System.out.println("Type the name you are looking for:");
    ...
    private static void findContact(Map<String, List<String>> contacts, Scanner input) {
        ...
        while (!number.matches("^\\+?[\\d ]{3,13}$")) {
            System.out.println("Invalid number! May contain only digits, spaces and '+'. Min length 3, max length 13.");
    ...
    private static void addContact(Map<String, List<String>> contacts, Scanner input) {
        System.out.println("You are going to add a new contact to the phone book.");
        String name;
        String number;
        ...
        while (true) {
            ...
            if (name.matches("^.{2,65}$")) {
                break;
            } else {
                System.out.println("Name must be in range 2 - 65 symbols.");
            }
        }
        ...
        while (true) {
            ...
            number = input.nextLine().trim();
            if (number.matches("^\\+?[\\d ]{3,13}$")) {
                break;
            } else {
                System.out.println("Number may contain only '+', spaces and digits. Min length 3, max length 13.");
            }
        }
    ...
    private static void editContact(Map<String, List<String>> contacts, Scanner input) {
        System.out.println("Enter a contact name you would like to modify:");
        String name = input.nextLine().trim();
    ...
    private static void deleteContact(Map<String, List<String>> contacts, Scanner input) {
        System.out.println("Enter the name of the contact which will be deleted:");
        String name = input.nextLine().trim();
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Phonebook made by Georgi Rusev");
        System.out.println("===========================");
